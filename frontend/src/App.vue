...
const { loadFromBackend, backendStatus, currentRole } = useHrState()
...
function handleEmployeeLogin(employeeId, role) {
  ...
  <div class="page-shell">
    ...
    <main class="container py-4 py-lg-5">
      ...
      <section v-else-if="authRole === 'hr'" class="reveal-in">
        ...
        <div v-if="backendStatus.error" class="alert alert-danger mb-4">
          Couldn't load live data: {{ backendStatus.error }}
        </div>
